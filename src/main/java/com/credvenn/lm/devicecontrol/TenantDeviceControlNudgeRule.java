...
@Entity
@Table(name = "tenant_device_control_nudge_rules")
public class TenantDeviceControlNudgeRule extends AuditableEntity {
    ...
    @Column(name = "nudge_code", nullable = false, length = 100)
    private String nudgeCode;
    ...
    public String getNudgeCode() { return nudgeCode; }
    public void setNudgeCode(String nudgeCode) { this.nudgeCode = nudgeCode; }
