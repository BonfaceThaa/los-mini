    ...
    public void provisionTenantRoles(String tenantId) {
        createOrUpdateSystemTenantRole(
                ...
                Set.of(
                        ...
                        PermissionCatalog.ORIGINATION_PROFILE_VIEW.code(),
                        PermissionCatalog.ORIGINATION_PROFILE_CREATE.code(),
                        PermissionCatalog.ORIGINATION_PROFILE_UPDATE.code(),
                        PermissionCatalog.LOGBOOK_VIEW.code(),
                        PermissionCatalog.LOGBOOK_VEHICLE_MANAGE.code(),
                        PermissionCatalog.LOGBOOK_VALUATION_SUBMIT.code(),
                        PermissionCatalog.LOGBOOK_VALUATION_REVIEW.code(),
                        PermissionCatalog.LOGBOOK_VERIFICATION_MANAGE.code(),
                        PermissionCatalog.APPLICATION_VARIABLE_MANAGE.code(),
